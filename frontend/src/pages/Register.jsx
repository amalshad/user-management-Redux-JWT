...
function Register() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-lime-sprout font-sans">
      <div className="w-full max-w-md bg-white shadow-lg shadow-gray-200/50 rounded-2xl p-10 border border-gray-200">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-2">
            Join User Management to get started today.
          </p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            ...
            />
            {errors.name && (
              <p className="text-red-500 text-xs mt-1.5 pl-1 font-medium">{errors.name}</p>
            )}
          </div>
        ...
        <p className="text-center text-sm text-gray-600 mt-8">
          ...
          <Link to="/login" className="text-fresh-canopy font-bold hover:underline">
            Sign in
          </Link>
        </p>
      </div>
